...
source activate hyphy-env
# Load the HyPhy module
...
#pathtree="gene_trees/ACmerged_contig_1011_pruned.treefile"
#pathmsa="cleaned_msa/ACmerged_contig_1011_NOSTOP_prunned.fna"
#pathout="output_meme/ACmerged_contig_1011_MEME.fna"
