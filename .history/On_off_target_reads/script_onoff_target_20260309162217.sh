...
bedtools intersect -abam aligned_reads.bam -b baits_coords.bed > on_target.bam
bedtools intersect -abam aligned_reads.bam -b baits_coords.bed -v > off_target.bam
