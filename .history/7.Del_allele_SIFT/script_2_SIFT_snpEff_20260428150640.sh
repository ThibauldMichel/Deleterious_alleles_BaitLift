...
# ------------------------------------------------------------------------------
LIFTED_VCF="$OUTPUT_DIR/lifted.vcf"
FAILED_VCF="$OUTPUT_DIR/lifted_failed.vcf"
SORTED_VCF="$OUTPUT_DIR/lifted_sorted.vcf.gz"
SIFT_RESULTS="$OUTPUT_DIR/sift_results"
SIFT_ANNOTATED_VCF=""   # populated later by find
SNPEFF_VCF="$OUTPUT_DIR/final_annotated.vcf"
SNPEFF_STATS="$OUTPUT_DIR/snpeff_stats.html"
